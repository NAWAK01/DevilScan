...
def mainmenu():
	...
	print "           ______( (_  / \___type 4 to find hostname with ip"
	print "         ,'  ,-----'   |        \      "
	print "         `--{__________)        \/     "
	print "                                       "
	print bcolors.ENDC
	...
	def choice2():
		...
		if choiceip == 1:
			with open(os.devnull, "wb") as limbo:
				inputip = raw_input("enter your network ip like that : '192.168.1.' > ")
	...
	def choice4():
            print "for find ip adress you can use function 2 of the main menu"
            ...
            choix = raw_input("Press [Q] to quit, and [D] to go to main menu > ")
